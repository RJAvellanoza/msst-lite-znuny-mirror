...
package Kernel::Modules::AgentEscalatedActiveTicketBreakdown;
...
sub Run {
    ...
    my $Output = $LayoutObject->Header(
        Title => 'Escalated Active Tickets',
    );
    $Output .= $LayoutObject->NavigationBar();
    $Output .= $LayoutObject->Output(
        TemplateFile => 'AgentEscalatedActiveTicketBreakdown',
        Data         => \%GetParam,
    );
...
sub _GetHourlyData {
    ...
    # Query escalated active ticket COUNT grouped by hour and priority
    # Escalated = ticket has MSITicketNumber populated
    # ACTIVE ONLY: ts.type_id != 3 (exclude closed tickets)
    my $SQL = q{
        SELECT
...
sub _GetDailyData {
    ...
    # Query escalated active ticket COUNT grouped by date and priority
    my $SQL = q{
        SELECT
...
sub _GetWeeklyData {
    ...
    # Query escalated active ticket COUNT grouped by week and priority
    my $SQL = q{
        SELECT
...
sub _GetMonthlyData {
    ...
    # Query escalated active ticket COUNT grouped by month and priority
    my $SQL = q{
        SELECT
...
sub _GetQuarterlyData {
    ...
    # Query escalated active ticket COUNT grouped by quarter and priority
    my $SQL = q{
        SELECT
...
sub _GetYearlyData {
    ...
    # Query escalated active ticket COUNT grouped by year and priority
    my $SQL = q{
        SELECT
