...
echo.
robocopy "%USERPROFILE%\PRJ\MSSTLITE\msst-lite-znuny" "%USERPROFILE%\PRJ\MSSTLITE-MIRROR\msst-lite-znuny-mirror" /MIR /XD .git scripts .claude /XF .gitignore CLAUDE.md
echo.
echo Done!
pause
